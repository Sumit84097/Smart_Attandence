...
while True:
    ret, frame = cap.read()
    if not ret:
        print("face is not recognition")
        continue  # skip the next iteration if frame is not captured
    ...
    #     file_name_path = 'D:/pythontut/smart_attandance/dataset/'+str(count)+'.jpg'
